...
public class UIManager {
	GamePanel gp;
	Graphics2D g2;
	BufferedImage image, sheet, backgroundSheet;
...
//	}
	...
	public void updateTitleState() {
		...
		if (gp.mouseL.mouseX > screenX &&
			gp.mouseL.mouseX < screenX + width &&
			gp.mouseL.mouseY > screenY &&
			gp.mouseL.mouseY < screenY + height) {
